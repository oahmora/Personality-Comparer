...
class ActualZodiac {
    ...
    public:
        ...
        /**
         * @brief  acceptVisitor takes a pointer to Behavior object and
         *         calls the ActualZodiac::match_zodiac function to get the
         *         zodiac sign of _birthday, and sets the Behavior::filename
         *         to this zodiac sign using the Behavior::set_filename method
         * @param  behavior a Behavior object that acts like a visitor to
         *         this class object
         */
        void acceptVisitor(Behavior* behavior);
